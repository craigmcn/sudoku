...
- #15, #16, #17, #18 done — all four issues split out of #13's Firebase puzzle-data plan are implemented. #13 (the umbrella issue) and #12 (Firebase login + per-user stats, which builds on this groundwork) remain open as the next planned work; #20 (minor #15-review follow-ups: hash independence, expert-difficulty test coverage) is also still open.
- No open questions blocking #12/#13 closeout.
